...
function PredefinedQuery({ setDefaults, setValue }) {
  ...
  return (
    <div>
      <div className="mx-auto flex items-center font-bold justify-center mt-2 py-2 h-11 px-5 rounded text-white bg-red-500 font-mono w-56 text-lg md:text-xl">
        React SQL Editor
      </div>
      <div className=" p-4 text-red-500">
        <div className="flex justify-center items-center">
          ...
          <p className="font-bold text-lg">Available dummy Queries </p>
        </div>
